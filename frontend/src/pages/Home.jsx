        ...
        <Typography variant="h5" sx={{ mb: 4, color: "text.secondary" }}>
          <Typewriter
            words={[
              ...
              "Use the real power of the Ai Aura",
              "To Login and use your free trail"
            ]}
            loop={true}
            cursor
            cursorStyle="|"
        ...
        >
          ...
          >
            ...
            <h6 className="text-center">
              Summaries the long text into the short text into understand better
            </h6>
          </Card>
          ...
          >
            ...
            <h6 className="text-center">
              Generate Paragraph or Code and find the solution
            </h6>
          </Card>
        </Box>

        {/* Additional Navigation Buttons */}
        <Stack direction="row" spacing={2} marginTop={8} marginBottom={6}>
          <Button
            variant="contained"
            color="primary"
